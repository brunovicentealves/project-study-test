package com.brunoalves.dscatalog.tests.integration.resource;
...
public class ProductResourceIT {
	...
	public void updateShouldReturnProductDTOWhenIdExists() throws Exception {
		...
		ProductDTO productDTO = ProductDTOMockRefatory.productDTORequestMock();
	...
	@Test
	public void updateShouldThrowNotFoundWhenDoesNotIdExists() throws Exception {
		...
		ResultActions result = mockMvc.perform(put("/products/{id}", nonExixstingId).content(jsonBody).contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON));
