...
public class EmployeeControllerIT {
	...
	public void findAllShouldReturnPagedResourcesSortedByName() throws Exception {
		...
		ResultActions result = mockMvc.perform(get("/employees?page=0&size=12&sort=name,asc").contentType(MediaType.APPLICATION_JSON));
	...
	public void insertShouldInsertResource() throws Exception {
		...
		ResultActions result = mockMvc
						.perform(post("/employees").content(jsonBody).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON));
